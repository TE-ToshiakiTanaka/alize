...
class TestCase(testcase.TestCase_Base):
    ...
    def expedition_result(self):
        if self.search("home\\expedition"):
            ...
            if self.search("home\\expedition\\success"):
    ...
    def attack(self, fleet, id):
        ...
        self.tap("attack\\start"); self.sleep(6)
    ...
    def battle(self):
        ...
        self.tap("attack\\compass"); self.sleep()
        while not self.search("basic\\next"):
            self.sleep()
            if self.tap("attack\\formation\\1"): self.sleep(10)
            if self.tap("attack\\night_battle\\stop"): self.sleep(5)
            self.sleep(10)
        while self.tap("basic\\next"): self.sleep(5)
        while not self.search("attack\\withdrawal"):
    ...
    def __docking(self):
        ...
        for _ in range(7):
            ...
            if self.search("docking\\unable"):
                self.sleep(2); self._tap(p, threshold=0.49); self.sleep(2)
            elif self.tap("docking\\start"):
                self.sleep(2)
                if self.tap("docking\\yes"):
